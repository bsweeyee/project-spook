//chooseUltimateType(negative_percent, neutral_percent, positive_percent)

var negative_percent = (argument[0] * 100);
var neutral_percent = negative_percent + (argument[1] * 100);
var positive_percent = neutral_percent + (argument[2] * 100);
